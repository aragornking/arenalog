var SPELLS_TABLE = {
    ...
    133 : ["Fireball", "Hurls a fiery ball that causes 1,841 Fire damage."],
    ...
    689 : ["Drain Life", "Drains the life from the target, causing 419 Shadow damage and restoring 2% of the caster's total health every 1 sec. Lasts 6 sec.Generates 10 Demonic Fury per second."],
    ...
    710 : ["Banish", "Banishes an enemy Demon, Aberration or Elemental for up to 30 sec.  BanishedThe target cannot act but is invulnerable. Limit 1 target.Casting Banish again will cancel the spell."],
    ...
    845 : ["Cleave", "A sweeping attack that strikes the target and an additional nearby target, dealing 82% weapon damage (115% if a one-handed weapon is equipped).Use when you have more Rage than you can spend."],
    ...
    982 : ["Revive Pet", "Revive your pet, returning it to life with 100% of its base health."],
    ...
    1513 : ["Scare Beast", "Scares a beast, causing it to run in fear for up to 20 sec.  Damage caused may interrupt the effect.  Only one beast can be feared at a time."],
    ...
    1680 : ["Whirlwind", "In a whirlwind of steel you attack all enemies within 8 yards, causing 85% weapon damage to each enemy."],
    ...
    2006 : ["Resurrection", "Brings a dead ally back to life with 35% health and mana.  Cannot be cast when in combat."],
    2008 : ["Ancestral Spirit", "Returns the spirit to the body, restoring a dead target to life with 35% of maximum health and mana.  Cannot be cast when in combat."],
    ...
    2637 : ["Hibernate", "Forces the enemy target to sleep for up to 40 sec.  Any damage will awaken the target.  Only one target can be forced to hibernate at a time.  Only works on Beasts and Dragonkin."],
    ...
    3674 : ["Black Arrow", "Fires a Black Arrow at the target, dealing 1,640 damage over 20 sec.  Black Arrow shares a cooldown with other Fire Trap spells."],
    ...
    7268 : ["Arcane Missiles", "Launches five waves of Arcane Missiles at the enemy over 2 sec, causing 273 Arcane damage per wave. Generates an Arcane Charge.Arcane Missiles' damage is increased by 50% per Arcane Charge.Arcane Missiles has a chance to be activated after each of your damaging spell casts. Limit 2 charges."],
    ...
    9484 : ["Shackle Undead", "Shackles the target undead enemy for up to 50 sec.  The shackled unit is unable to move, attack or cast spells.  Any damage caused will release the target.  Only one target can be shackled at a time."],
    ...
    10789 : ["Spotted Frostsaber", "Summons and dismisses a rideable Spotted Frostsaber"],
    ...
    12486 : ["Chilled", "Chills the target for 1.50 sec."],
    ...
    13809 : ["Ice Trap", "Place a frost trap that creates an ice slick around itself for 30 sec when the first enemy approaches it. All enemies within 10 yards will be slowed by 50% while in the area of effect. Trap will exist for 1 min."],
    13812 : ["Explosive Trap", "Place a fire trap that explodes when an enemy approaches, causing 250.50 Fire damage and burning all enemies within 10 yards for 350 additional Fire damage over 20 sec.  Trap will exist for 1 min."],
    ...
    17229 : ["Winterspring Frostsaber", "Summons and dismisses a rideable Winterspring Frostsaber."],
    ...
    17619 : ["Alchemist Stone", "Increases the effect that healing and mana potions have on the wearer by 40%.  This effect does not stack."],
    ...
    18223 : ["Curse of Exhaustion", "Reduces the target's movement speed by 30% for 30 sec.CursesA Warlock can only have one Curse active per target."],
    ...
    19185 : ["Entrapment", "When your Ice Trap or Snake Trap are triggered you entrap all afflicted targets, preventing them from moving for 2 sec."],
    ...
    20165 : ["Seal of Insight", "Fills you with Holy Light, increasing your casting speed by 10%, improving healing spells by 5% and giving melee attacks a chance to heal you for 37 and restore 4% of base mana."],
    ...
    22703 : ["Infernal Awakening", "An infernal falls from the sky, dealing 1,255 Fire damage to all targets, stunning them for 2 sec."],
    ...
    23241 : ["Swift Blue Raptor", "Summons and dismisses a rideable Swift Blue Raptor."],
    ...
    23509 : ["Frostwolf Howler", "Summons and dismisses a rideable Frostwolf Howler."],
    ...
    25046 : ["Arcane Torrent", "Silence all enemies within 8 yards for 2 sec and restore 15 Energy.  Non-player victim spellcasting is also interrupted for 3 sec."],
    ...
    25810 : ["Mind-numbing Poison", "Casting speed slowed by 30%. Lasts 12 sec."],
    26013 : ["Deserter", ""],
    ...
    30451 : ["Arcane Blast", "Blasts the target with energy, dealing 954.50 Arcane damage. Generates an Arcane Charge.Arcane Blast's damage is increased by 50% per Arcane Charge, and its mana cost is increased by 150% per Arcane Charge."],
    ...
    31935 : ["Avenger's Shield", "Hurls your shield at an enemy target, dealing 6,837 Holy damage, silencing and interrupting spellcasting for 3 sec, and then jumping to additional nearby enemies.Affects 3 total targets."],
    ...
    32239 : ["Ebon Gryphon", "Summons and dismisses a rideable Ebon Gryphon.  The capabilities of this mount depend on your Riding skill and location."],
    ...
    32243 : ["Tawny Wind Rider", "Summons and dismisses a rideable Tawny Wind Rider mount.  The capabilities of this mount depend on your Riding skill and location."],
    ...
    32246 : ["Swift Red Wind Rider", "Summons and dismisses a rideable Swift Red Wind Rider mount.  The capabilities of this mount depend on your Riding skill and location."],
    ...
    32295 : ["Swift Green Wind Rider", "Summons and dismisses a rideable Swift Green Wind Rider mount.  The capabilities of this mount depend on your Riding skill and location."],
    32296 : ["Swift Yellow Wind Rider", "Summons and dismisses a rideable Swift Yellow Wind Rider mount.  The capabilities of this mount depend on your Riding skill and location."],
    ...
    33831 : ["Force of Nature", "Summons a Treant which will immediately root your current target for 30 sec.  The Treant will cast Wrath at that target for 1,698 Nature damage every 2 sec.  Lasts 15 sec.  Maximum 3 charges."],
    ...
    34897 : ["White War Talbuk", "Summons and dismisses a rideable White War Talbuk."],
    ...
    35018 : ["Purple Hawkstrider", "Summons and dismisses a rideable Purple Hawkstrider."],
    ...
    35290 : ["Gore", "Your boar gores the enemy, causing it to take 4% increased physical damage for 30 sec."],
    35395 : ["Crusader Strike", "An instant strike that causes 125% weapon damage plus 791."],
    36032 : ["Arcane Charge", "An arcane charge, generated by Arcane Blast, Arcane Missiles, and Arcane Explosion, and consumed by Arcane Barrage and Evocation:  Arcane BlastGenerates a charge.Arcane Blast's damage is increased by 50% per charge, and its mana cost increased by 150% per charge.  Arcane MissilesGenerates a charge.Arcane Missiles' damage is increased by 50% per charge.   Arcane ExplosionRefreshes charges and has a 30% chance to generate a charge if at least one target is hit.  Arcane BarrageConsumes all charges.Arcane Barrage's damage is increased by 50% per charge, and it hits 1 additional nearby target per charge for 50% damage.  EvocationConsumes all charges.Evocation's mana generation is increased by 25% per charge.Stacks up to 4 times and lasts 10 sec."],
    ...
    43927 : ["Cenarion War Hippogryph", "Summons and dismisses a rideable Cenarion War Hippogryph mount.  The capabilities of this mount depend on your Riding skill and location."],
    ...
    44425 : ["Arcane Barrage", "Launches bolts of arcane energy at the enemy target, causing 1,228 Arcane damage. Consumes all Arcane Charges.Arcane Barrage's damage is increased by 50% per Arcane Charge, and it hits 1 additional nearby target per Arcane Charge for 50% damage."],
    ...
    45902 : ["Blood Strike", "Instantly strike the enemy, causing 40% weapon damage plus 377.  Damage is increased by 12.5% for each of your diseases on the target."],
    ...
    50519 : ["Sonic Blast", "Emits a piercing shriek, stunning the target for 2 sec."],
    50541 : ["Clench", "The scorpid clenches the enemy's weapons with its claws, disarming their weapons and shield for 8 sec."],
    50613 : ["Arcane Torrent", "Silence all enemies within 8 yards for 2 sec and restore 15 Runic Power.  Non-player victim spellcasting is also interrupted for 3 sec."],
    ...
    53301 : ["Explosive Shot", "You fire an explosive charge into the enemy target, dealing 384 Fire damage initially and every second for 2 sec and applying the Hunter's Mark effect."],
    ...
    53385 : ["Divine Storm", "An area attack that consumes 3 charges of Holy Power to cause 100% weapon damage as Holy damage to all enemies within 8 yards."],
    ...
    54706 : ["Venom Web Spray", "Sprays toxic webs at the target, preventing movement for 5 sec."],
    54729 : ["Winged Steed of the Ebon Blade", "Summons and dismisses your Winged Steed of the Ebon Blade.  This is a flying mount."],
    54753 : ["White Polar Bear", "Summons and dismisses a rideable White Polar Bear."],
    54786 : ["Demonic Leap", "Leap through the air 16 yards in front of you, slamming down on all enemies within 5 yards of the target area, causing 2,725 Shadow damage and stunning them for 2 sec."],
    ...
    55500 : ["Lifeblood", "Uses your skill in Herbalism to absorb energy and nutrients from the earth, instantly healing minor wounds and granting 55 haste for 20 sec.  Can be used while stealthed or invisible."],
    55503 : ["Lifeblood", "Uses your skill in Herbalism to absorb energy and nutrients from the earth, instantly healing minor wounds and granting 240 haste for 20 sec.  Can be used while stealthed or invisible."],
    ...
    56453 : ["Lock and Load", "You have a 100% chance when you trap a target with Freezing Trap or Ice Trap, and a 20% chance when your Black Arrow or Explosive Trap deals damage to cause your next two Explosive Shots to cost no Focus and trigger no cooldown. Effect lasts for 12 sec and cannot occur more often than once every 10 sec."],
    56626 : ["Sting", "Your wasp stings the target, stunning them for 2 sec."],
    ...
    57386 : ["Stampede", "Your rhino slams into a nearby enemy, causing it to take 4% increased physical damage for 30 sec."],
    ...
    57820 : ["Ebon Champion", "You champion the cause of the Knights of the Ebon Blade.  All reputation gains while in level 80 dungeons will be applied to your standing with them."],
    ...
    59548 : ["Gift of the Naaru", "Heals the target for 20% of the caster's total health over 15 sec."],
    ...
    59785 : ["Black War Mammoth", "Summons and dismisses a rideable Black War Mammoth."],
    ...
    60114 : ["Armored Brown Bear", "Summons and dismisses a rideable armored brown bear."],
    60116 : ["Armored Brown Bear", "Summons and dismisses a rideable armored brown bear."],
    ...
    60234 : ["Intellect", "Increases your Intellect for 15 sec."],
    ...
    61229 : ["Armored Snowy Gryphon", "Summons and dismisses a rideable Armored Snowy Gryphon mount.  The capabilities of this mount depend on your Riding skill and location."],
    61230 : ["Armored Blue Wind Rider", "Summons and dismisses a rideable Armored Blue Wind Rider mount.  The capabilities of this mount depend on your Riding skill and location."],
    ...
    61305 : ["Polymorph", "Transforms the enemy into a harmless black cat, forcing it to pussyfoot around for up to 50 sec.  While wandering, the cat cannot attack or cast spells but will regenerate very quickly.  Any damage will transform the target back into its normal form.  Only one target can be polymorphed at a time.  Only works on Beasts, Humanoids and Critters."],
    ...
    61394 : ["Frozen Wake", "When your Freezing Trap breaks, the victim's movement speed is reduced by 70% for 4 sec."],
    ...
    61780 : ["Polymorph", "Transforms the enemy into a harmless Turkey, forcing it to waddle around for up to 50 sec.  While waddling, the turkey cannot attack or cast spells but will regenerate very quickly.  Any damage will transform the target back into its normal form.  Only one target can be polymorphed at a time.  Only works on Beasts, Humanoids and Critters."],
    ...
    64803 : ["Entrapment", "When your Ice Trap or Snake Trap are triggered you entrap all afflicted targets, preventing them from moving for 4 sec."],
    ...
    65638 : ["Swift Moonsaber", "Summons and dismisses a rideable Swift Moonsaber."],
    65917 : ["Magic Rooster", "Summons and dismisses a rideable Magic Rooster.  No, seriously."],
    66091 : ["Sunreaver Hawkstrider", "Summons and dismisses a rideable Sunreaver Hawkstrider."],
    66846 : ["Ochre Skeletal Warhorse", "Summons and dismisses a rideable Ochre Skeletal Warhorse."],
    66847 : ["Striped Dawnsaber", "Summons and dismisses a rideable Striped Dawnsaber."],
    66906 : ["Argent Charger", "Summons an Argent Charger, which serves as a mount."],
    ...
    69179 : ["Arcane Torrent", "Silence all enemies within 8 yards for 2 sec and increase your Rage by 15.  Non-player victim spellcasting is also interrupted for 3 sec."],
    ...
    72286 : ["Invincible", "Summons and dismisses the flying undead horse Invincible.  This mount changes depending on your Riding skill and location."],
    ...
    76780 : ["Bind Elemental", "Binds the target hostile elemental for up to 50 sec.  The bound unit is unable to move, attack or cast spells.  Any damage caused will release the target.  Only one target can be bound at a time."],
    ...
    77761 : ["Stampeding Roar", "The Druid roars, increasing the movement speed of all friendly players within 10 yards by 60% for 8 sec and removing all roots and snares on those targets."],
    ...
    79438 : ["Soulburn: Demonic Circle", "Movement speed increased by 50%.Immune to snares and roots."],
    ...
    79683 : ["Arcane Missiles!", "Your offensive spells have a chance to activate Arcane Missiles. This effect can accumulate up to 2 charges and lasts 20 sec."],
    ...
    81162 : ["Will of the Necropolis", "When a damaging attack brings you below 30% of your maximum health, you generate a Blood Rune and the cooldown on your Rune Tap ability is refreshed, and all damage taken is reduced for 8 sec.  This effect cannot occur more than once every 15 seconds."],
    ...
    81281 : ["Fungal Growth", "When your Wild Mushrooms are triggered, you create a Fungal Growth in each mushroom's wake covering an area within 8 yards, slowing all enemy targets by 50%, and lasting 20 sec."],
    ...
    81708 : ["Lifeblood", "Uses your skill in Herbalism to absorb energy and nutrients from the earth, instantly healing minor wounds and granting 5 haste for 20 sec.  Can be used while stealthed or invisible."],
    ...
    82941 : ["Ice Trap", "Launch a frost trap to the target location that creates an ice slick around itself for 30 sec when the first enemy approaches it.  All enemies within 10 yards will be slowed by 50% while in the area of effect.  Trap will exist for 1 min."],
    ...
    85222 : ["Light of Dawn", "Consumes up to 3 Holy Power to emanate a wave of healing energy, healing up to 6 of the most injured targets in your party or raid within 30 yards for 1,748 per charge of Holy Power."],
    ...
    87023 : ["Cauterize", "An attack which would otherwise kill you will instead bring you to 50% of your maximum health, and you will burn for 40% of your maximum health over the next 6 sec.Cauterize cannot occur more than once every 2 min."],
    87024 : ["Cauterized", "An attack which would otherwise kill you will instead bring you to 50% of your maximum health, and you will burn for 40% of your maximum health over the next 6 sec.Cauterize cannot occur more than once every 2 min."],
    ...
    88751 : ["Wild Mushroom: Detonate", "Detonates all of your Wild Mushrooms, dealing 388.50 Nature damage to all nearby targets within 8 yards, and creating a Fungal Growth in each mushroom's wake covering an area within 8 yards, slowing all enemy targets by 50%, and lasting 20 sec."],
    ...
    89420 : ["Drain Life", "Drains the life from the target, causing 419 Shadow damage and restoring 3% of the caster's total health every 1 sec. Lasts 6 sec."],
    ...
    90315 : ["Tailspin", "Your fox twirls its tail around, kicking up an obscuring cloud of dust, causing all enemies within 10 yards to have their spell cast speed increased by 50% (25% on player targets) for 30 sec."],
    90327 : ["Lock Jaw", "Dog locks its jaws on the target, holding it in place for 4 sec."],
    ...
    92146 : ["Scarab Storm", "Summons a storm of peaceful scarabs."],
    ...
    92232 : ["Spectral Wolf", "Summons and dismisses a rideable Spectral Wolf."],
    ...
    93805 : ["Ironforge Champion", "You champion the cause of Ironforge.  All reputation gains while in dungeons will be applied to your standing with them."],
    ...
    94462 : ["Undercity Champion", "You champion the cause of Undercity.  All reputation gains while in dungeons will be applied to your standing with them."],
    ...
    96171 : ["Will of the Necropolis", "When a damaging attack brings you below 30% of your maximum health, the cooldown on your Rune Tap ability is refreshed and your next Rune Tap has no cost."],
    ...
    96491 : ["Armored Razzashi Raptor", "Summons and dismisses a rideable Armored Razzashi Raptor."],
    ...
    99712 : ["Call of Dominance", "Increases spell power by 1,794 for 20 sec."],
    99719 : ["Surge of Dominance", "Increases spell power by 1,077 for 20 sec."],
    ...
    102351 : ["Cenarion Ward", "Protects a friendly target, causing any damage taken to heal the target for 12,543 every 2 sec for 6 sec.  Gaining the healing effect consumes the Cenarion Ward.  Useable in all shapeshift forms.  Lasts 30 sec."],
    102352 : ["Cenarion Ward", "Heals the target for 12,543 every 2 sec for 6 sec."],
    ...
    102417 : ["Wild Charge", "Leap forward 20 yards."],
    ...
    102791 : ["Wild Mushroom: Bloom", "Causes all of your Wild Mushrooms to bloom, healing all allies within 10 yards for 4,544.Bonus healing on the Wild Mushroom will be divided across all targets healed."],
    ...
    102795 : ["Bear Hug", "Melee attack that stuns the target for 3 sec and each 1 sec deals 10% of the Druid's health in damage.  The Druid is immobilized for 3 sec.  Using this ability activates Bear Form."],
    103081 : ["Darkmoon Dancing Bear", "Summons and dismisses a rideable Darkmoon Dancing Bear."],
    ...
    104045 : ["Sleep", "Makes the target drowsy, causing it to sleep for up to 20 sec.Sleep RestrictionsDamage caused may cancel sleep. Limit 1 target."],
    ...
    107516 : ["Spectral Gryphon", "Summons and dismisses a rideable Spectral Gryphon mount.  This is a flying mount."],
    ...
    108211 : ["Leeching Poison", "Coats your weapons with a Non-Lethal Poison that lasts for 1 hour.  Your melee attacks have a 50% chance to poison the target for 10 sec. Your subsequent weapon strikes against the poisoned target will heal you for 10% of damage dealt."],
    ...
    108446 : ["Soul Link", "When active, all damage and healing you and your demon take is shared, but your demon's health is reduced by 50%. Recasting this spell cancels the effect.Replaces Health Funnel."],
    ...
    108839 : ["Ice Floes", "Allows you to move while casting and channeling the next 2 Mage spells that have a base cast or channel time less than 4 sec. This spell may be cast while a cast time spell is in progress and is not on the global cooldown. Lasts 15 sec."],
    ...
    110570 : ["Anti-Magic Shell", "Surrounds the Druid in an Anti-Magic Shell, absorbing 30% of the damage dealt by harmful spells (up to a maximum of 25% of the Druid's health) and preventing application of harmful magical effects.  Lasts 5 sec."],
    ...
    110617 : ["Deterrence", "When activated, increases the chance melee attacks will miss you by 100%, reduces the chance ranged attacks will hit you by 100% and grants a 100% chance to deflect spells.  While Deterrence is active, you cannot attack.  Lasts 5 sec."],
    110693 : ["Frost Nova", "Blasts enemies near the caster, freezing them in place for up to 8 sec.  Damage caused may interrupt the effect."],
    ...
    110700 : ["Divine Shield", "Protects you from all damage and spells for 8 sec, but reduces all damage you deal by 50%.  Cannot be used on a target with Forbearance.  Causes Forbearance for 1 min."],
    ...
    112867 : ["Summon Voidlord", "Summons a Voidlord under the command of the Warlock.Voidlords can withstand heavy punishment, disarm melee attackers, deal Shadow damage to enemies who harm them, increase their health when near death and taunt enemies attacking their master."],
    ...
    112869 : ["Summon Observer", "Summons an Observer under the command of the Warlock.Observers are drawn to magic, use powerful optical attacks which interrupt spellcasting and heal themselves by stealing beneficial magic effects from enemies."],
    112870 : ["Summon Wrathguard", "Summons a Wrathguard under the command of the Warlock.Wrathguard are powerful melee fighters who excel against multiple targets, can perform a powerful area attack, stun an opponent at range and greatly reduce healing received by their target."],
    ...
    112961 : ["Leeching Poison", "Poisons an enemy for 10 sec.  Subsequent weapon strikes against the poisoned target will heal the Rogue for 10% of damage dealt."],
    112970 : ["Demonic Circle: Teleport", "Symbiosis: Removes all snare effects, and teleports you to the Demonic Circle owned by the Warlock to whom you are Symbiotically linked."],
    ...
    113002 : ["Spell Reflection", "Reflect the next spell cast on you.  Lasts 5 sec."],
    ...
    113287 : ["Solar Beam", "Symbiosis: You summon a beam of solar light over the enemy target's location, interrupting the enemy target and silencing all enemy targets under the beam while it is active. Solar Beam lasts for 8 sec."],
    ...
    113770 : ["Entangling Roots", "Roots the target in place for 30 sec.  Damage caused may interrupt the effect."],
    ...
    113801 : ["Bash", "Stuns the target for 3 sec."],
    ...
    114794 : ["Demonic Circle: Teleport", "Teleports you to your Demonic Circle and removes all snare effects."],
    ...
    115610 : ["Temporal Shield", "Envelops you in a temporal shield for 4 sec. Damage taken while shielded will be healed back over 6 sec. This spell is usable while stunned, frozen, incapacitated, feared or asleep, and is not on the global cooldown."],
    115611 : ["Temporal Ripples", "Envelops you in a temporal shield for 4 sec. Damage taken while shielded will be healed back over 6 sec. This spell is usable while stunned, frozen, incapacitated, feared or asleep, and is not on the global cooldown."],
    ...
    116011 : ["Rune of Power", "Places a Rune of Power on the ground, which lasts for 1 min. While standing in your own Rune of Power, your mana regeneration is increased by 75% and your spell damage is increased by 15%. Only 2 Runes of Power can be placed at one time.Replaces Evocation."],
    116014 : ["Rune of Power", "Places a Rune of Power on the ground, which lasts for 1 min. While standing in your own Rune of Power, your mana regeneration is increased by 75% and your spell damage is increased by 15%. Only 2 Runes of Power can be placed at one time.Replaces Evocation."],
    ...
    117647 : ["Silkbead Emblem", "Grants 1,218 critical strike for 20 sec."],
    ...
    118093 : ["Disarm", "The Voidwalker strikes at the target's hand, disarming their weapons and shield for 8 sec."],
    ...
    118345 : ["Pulverize", "Smashes an enemy with a rocky fist, dealing 150% of the damage of a normal attack, and stunning the target for 4 sec."],
    118358 : ["Drink", "Restores 300,000 mana over 20 sec.  Must remain seated while drinking."],
    118470 : ["Unleashed Fury", "Increases the enemy target's damage taken from your Lightning Bolt by 20%, and from your Lava Burst by 10% for 10 sec."],
    ...
    118674 : ["Vital Mists", "You become adept in the ways of the Mistweaver, amplifying four of your abilities.Crackling Jade LightningDamage increased by 100%.Tiger PalmDamage increased by 100%. When you Tiger Palm, you gain Vital Mists, reducing the cast time and mana cost of your next Surging Mist by 20%. Stacks up to 5 times. Lasts 30 sec.Blackout KickBlackout Kick also hits 4 additional nearby targets for 50% damage.When you Blackout Kick, you gain Serpent's Zeal causing you to heal nearby injured targets equal to 25% of your auto-attack damage.Spinning Crane KickWhile channeling Spinning Crane Kick, you also heal nearby injured allies for 2,812 every 0.75 sec for 2.25 sec. Healing yourself does not count for Chi generation."],
    ...
    119072 : ["Holy Wrath", "Sends bolts of power in all directions, causing 170 Holy damage divided among all enemies within 10 yards, stunning Demons and Undead for 3 sec."],
    ...
    119308 : ["Counterspell", "Counters the enemy's spellcast, preventing any spell from that school of magic from being cast for 6 sec.Can be cast while casting or channeling other spells."],
    119381 : ["Leg Sweep", "You knock down all enemies within 5 yards, effectively stunning them for 5 sec."],
    119392 : ["Charging Ox Wave", "A mighty Ox effigy rushes forward 30 yards in front of you, stunning all enemies within its path for 3 sec."],
    ...
    119696 : ["Debilitation", "Eviscerate and Envenom also reduce the movement speed of the target by 50% for 6 sec."],
    ...
    120360 : ["Barrage", "Rapidly fire a spray of shots forward for 3 sec, dealing a total of 640% weapon damage to the enemy target and an average of 320% weapon damage to each other enemy target in front of you.Useable while moving."],
    120361 : ["Barrage", "Rapidly fire a spray of shots forward for 3 sec, dealing a total of 640% weapon damage to the enemy target and an average of 320% weapon damage to each other enemy target in front of you.Useable while moving."],
    120395 : ["Green Dragon Turtle", "Summons and dismisses a rideable Green Dragon Turtle."],
    ...
    121536 : ["Angelic Feather", "Place a feather at the target location. If allies walk through it, they gain 60% increased movement speed for 6 sec. Only 3 feathers can be placed at one time. Accumulates an additional charge once every 10 sec."],
    121557 : ["Angelic Feather", "Place a feather at the target location. If allies walk through it, they gain 60% increased movement speed for 6 sec. Only 3 feathers can be placed at one time. Accumulates an additional charge once every 10 sec."],
    121783 : ["Emancipate", "Unshackles your spirit, freeing you from one movement impairing effect."],
    ...
    121820 : ["Obsidian Nightwing", "Transforms you into an Obsidian Nightwing, allowing you to fly very fast and carry an ally on your back.  This is a flying mount."],
    ...
    122032 : ["Exorcism", "Forcefully attempt to expel the evil from the target with a blast of Holy Light. Causes 6,998 Holy damage to the target and 25% of that to other enemies within 8 yards and generates a charge of Holy Power."],
    ...
    122242 : ["Clash", "You and the target charge each other, meeting halfway then stunning all targets within 6 yards for 4 sec."],
    122278 : ["Dampen Harm", "You dampen the damage from the most harmful attacks done to you. The next 3 attacks within 45 sec that deal damage equal to 20% or more of your total health are reduced by half.Dampen Harm can be cast while stunned."],
    122291 : ["Unending Resolve", "The Druid's skin hardens, reducing all damage taken by 40% and preventing spells from being interrupted for 12 sec."],
    ...
    122688 : ["Braid of Ten Songs", "Grants 1,851 haste for 20 sec."],
    122691 : ["Relic of Kypari Zar", "Grants 1,851 critical strike for 20 sec."],
    122693 : ["Emblem of Kypari Zar", "Grants 1,851 haste for 20 sec."],
    ...
    123981 : ["Perdition", "You cannot benefit from Purgatory again for 3 min."],
    ...
    126236 : ["Slippery", "Dodge increased by 103 for 15 sec."],
    ...
    126355 : ["Paralyzing Quill", "Fires paralyzing quills around the porcupine, incapacitating all enemies for 2 sec."],
    ...
    126423 : ["Petrifying Gaze", "Turns the target into stone for 3 sec, causing them to be invulnerable."],
    ...
    126451 : ["Clash", "You and the target charge each other, meeting halfway then stunning all targets within 6 yards."],
    126458 : ["Grapple Weapon", "You fire off a rope spear, grappling the target's non-ranged weapons and shield, returning them to you for 8 sec."],
    126483 : ["Windswept Pages", "Increases haste by 103 for 20 sec."],
    126484 : ["Flashing Steel", "Increases your Agility by 129 for 15 sec."],
    ...
    126554 : ["Agile", "Agility increased by 77 for 20 sec."],
    126577 : ["Inner Brilliance", "Intellect increased by 77 for 20 sec."],
    ...
    127216 : ["Grey Riding Yak", "Summons and dismisses a rideable Grey Riding Yak."],
    ...
    127290 : ["Red Dragon Turtle", "Summons and dismisses a rideable Red Dragon Turtle."],
    127310 : ["Great Purple Dragon Turtle", "Summons and dismisses a rideable Great Purple Dragon Turtle."],
    ...
    127575 : ["Perfection", "Increases your Agility by 129 for 20 sec."],
    ...
    127722 : ["Serpent's Zeal", "When you Blackout Kick, you gain Serpent's Zeal causing you to heal nearby injured targets equal to 25% of your auto-attack damage."],
    ...
    127915 : ["Essence of Life", "Increases haste by 155 for 10 sec."],
    128386 : ["Mantid Poison", "Deals 147 nature damage every 1.50 sec for 6 sec."],
    ...
    128984 : ["Blessing of the Celestials", "Agility increased by 82.  Lasts 15 sec."],
    128985 : ["Blessing of the Celestials", "Intellect increased by 82.  Lasts 15 sec."],
    ...
    129597 : ["Arcane Torrent", "Silence all enemies within 8 yards for 2 sec and restore 1 Chi.  Non-player victim spellcasting is also interrupted for 3 sec."],
    129812 : ["Hunger", "Increases your haste by 86 for 15 sec."],
    ...
    129935 : ["Red Shado-Pan Riding Tiger", "Summons and dismisses a rideable Red Shado-Pan Riding Tiger."],
    ...
    130616 : ["Fear", "Strikes fear in the enemy, causing it to flee for up to 20 sec.Fear RestrictionsDamage caused may cancel fear. Limit 1 target."],
    ...
    130965 : ["Son of Galleon", "Summons and dismisses a rideable Son of Galleon."],
    ...
    131557 : ["Spiritwalker's Aegis", "When you cast Spiritwalker's Grace, you become immune to Silence and Interrupt effects for 5 sec."],
    ...
    132412 : ["Seduction", "Seduces the target, preventing all actions for up to 30 sec.  Any damage caused will remove the effect.  Only works against Humanoids.Auto-Cast:Cast upon targets who stun, silence or fear their master.(Right-Click to toggle)"],
    ...
    135299 : ["Ice Trap", "Place a frost trap that creates an ice slick around itself for 30 sec when the first enemy approaches it. All enemies within 10 yards will be slowed by 50% while in the area of effect. Trap will exist for 1 min."],
    135373 : ["Entrapment", "When your Ice Trap or Snake Trap are triggered you entrap all afflicted targets, preventing them from moving for 4 sec."],
    ...
    136084 : ["Sense for Weakness", "Increases your critical strike by 86 for 15 sec."],
    ...
    137596 : ["Capacitance", "Gained Capacitance.  When you reach 5 charges, they will release, dealing a Lightning Strike for 323 Nature damage against your current target."],
    ...
    138162 : ["Exorcism", "Increases Holy damage taken from the casting Paladin's attacks by 6%."],
    138165 : ["Templar's Verdict", "A powerful weapon strike that consumes 3 charges of Holy Power to deal 275% weapon damage plus 628."],
    138169 : ["Templar's Verdict", "Your next Templar's Verdict will deal all Holy damage instead of Physical."],
    138213 : ["Survivor's Bag", ""],
    138242 : ["Shield of Glory", "Increases block chance by 40% for 5 sec."],
    138424 : ["Amber Primordial Direhorn", "Summons and dismisses a rideable Amber Primordial Direhorn."],
    138425 : ["Slate Primordial Direhorn", "Summons and dismisses a rideable Slate Primordial Direhorn."],
    138426 : ["Jade Primordial Direhorn", "Summons and dismisses a rideable Jade Primordial Direhorn."],
    ...
    138724 : ["Lifeblood", "Gain 523 mana."],
    138759 : ["Feathers of Fury", "Grants 28 Strength, increasing by 28 every 2 sec.  Lasts 20 sec."],
    138760 : ["Mighty", "Grants 28 Strength."],
    138786 : ["Wushoolay's Lightning", "Grants 23 Intellect, increasing by 23 every 2 sec.  Lasts 20 sec."],
    138788 : ["Electrified", "Grants 23 Intellect."],
    138856 : ["Cloudburst", "Grants 29 mana every 2 sec for 10 sec."],
    138870 : ["Rampage", "Strength increased by 27 for 10 sec."],
    138898 : ["Breath of Many Minds", "Intellect increased by 129 for 20 sec."],
    ...
    139133 : ["Mastermind", "Intellect increased by 129 for 10 sec."],
    139170 : ["Eye of Brutality", "Critical Strike increased by 50 for 20 sec.  Stacks up to 3 times."],
    ...
    139595 : ["Armored Bloodwing", "Summons and dismisses an Armored Bloodwing.  This mount changes depending on your Riding skill and location."],
    ...
    142241 : ["Brawling Champion", "Show off your brawling accomplishments."],
    142243 : ["Brawling Champion", "Show off your brawling accomplishments."],
    142247 : ["Brawling Champion", "Celebrate your victory over last year's Blingtron by wearing last year's shirt."],
    142530 : ["Bloody Dancing Steel", "Strength or Agility increased by 1,650."],
    142641 : ["Brawler's Burly Mushan Beast", "Summons and dismisses a rideable Brawler's Burly Mushan Beast."],
